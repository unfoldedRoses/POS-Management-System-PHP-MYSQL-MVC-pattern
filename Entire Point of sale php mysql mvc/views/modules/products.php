...
<div class="col-xs-12 col-sm-6">
  ...
  <div class="input-group"> 
    ...
    <input type="text" class="form-control input-lg" id="buyersordernumber" name="buyersordernumber" step="any"  placeholder="Buyers order no" required>
...
<div class="col-xs-12 col-sm-6">  
  ...
  <div class="input-group"> 
    ...
    <input type="text" class="form-control input-lg" id="dispatchthrough" name="dispatchthrough" step="any"  placeholder="dispatch through" required>
  ...
  <br>
                ...
                <div class="col-xs-6" style="padding:0">
                  ...
                  <div class="input-group"> 
                    ...
                    <input type="number" class="form-control input-lg newPercentage" min="0" value="19" required>

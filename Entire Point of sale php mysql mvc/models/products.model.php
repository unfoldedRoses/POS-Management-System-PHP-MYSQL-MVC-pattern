...
class ProductsModel{
	...
	static public function mdlAddProduct($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(idCategory, code, description, image, stock, buyingPrice, sellingPrice,buyersordernumber,dispatchthrough) VALUES (:idCategory, :code, :description, :image, :stock, :buyingPrice, :sellingPrice,:buyersordernumber,:dispatchthrough)");
		...
		$stmt->bindParam(":buyersordernumber", $data["buyersordernumber"], PDO::PARAM_STR);
		$stmt->bindParam(":dispatchthrough", $data["dispatchthrough"], PDO::PARAM_STR);
